/*--------------------------------------------------------------------
 * $Id: ascii.c 3521 2019-12-11 22:28:30Z Claudia.Emde $
 * 
...
int ASCII_checkfile_nrows (const char *filename, int nrows, 
			   int *rows,
			   int *min_columns,
			   int *max_columns,
			   int *max_length)
...
int ASCII_readfile_nrows (const char *filename, int nrows,
			  char ***array)
{
  FILE *f=NULL;
  char line[MAX_LENGTH_OF_LINE+1]="";
...
int ASCII_file2double_nrows (const char *filename, int nrows,
			     int *rows,        
			     int *max_columns, 
			     int *min_columns, 
			     double ***value)  
...
int ASCII_file2double (const char *filename,   
		       int *rows,        
		       int *max_columns, 
		       int *min_columns, 
		       double ***value)  
