/*--------------------------------------------------------------------
 * $Id: redistribute.c 3423 2018-09-13 20:14:04Z bernhard.mayer $
 * 
			    ...
			    float *zd_common, int nlyr_common)
{
  ...
  */
  ...
  if(!(tmpopt = calloc_float_5D_restricted ((size_t) Nx, (size_t) Ny, (size_t) nlyr,
					    (size_t) nlambda_lower, (size_t) nlambda_upper, nq, "tmpopt"))) return -1;
  ...
  */
  ...
  if(!(optprop->tau_molabs_r= calloc_float_5D_restricted ((size_t) Nx, (size_t) Ny, (size_t) nlyr_common,
							  (size_t) nlambda_lower, (size_t) nlambda_upper, nq, "optprop->tau_molabs_r"))) return -1;
  ...
  */
  ...
  if(!(optprop->tau_molabs_md_r = calloc_float_5D_restricted (1, 1, (size_t) nlyr_common,
							      (size_t) nlambda_lower, (size_t) nlambda_upper, nq, "optprop->tau_molabs_md_r"))) return -1;
  ...
  */
  ...
  if(!(optprop->tau_rayleigh_r= calloc_float_5D_restricted ((size_t) Nx, (size_t) Ny, (size_t) nlyr_common,
							    (size_t) nlambda_lower, (size_t) nlambda_upper, nq, "optprop->tau_rayleigh_r"))) return -1;
